...
import { clearSession, getAccessToken, isDemoOrganization } from '../auth';
...
export const API_MODE: 'demo' | 'live' = (
  (import.meta as any).env?.VITE_API_MODE === 'demo' || isDemoOrganization()
) ? 'demo' : 'live';
