...
DEMO_EDGES = [
    ...
    {"external_edge_id": "demo-27", "source_name": "SIH demo", "source_node": "Internet", "target_node": "Partner SFTP Gateway", "relation_type": "partner ingress", "source_kind": "INTERNET", "target_kind": "API", "confidence": .92, "evidence": {}},
    {"external_edge_id": "demo-28", "source_name": "SIH demo", "source_node": "Partner SFTP Gateway", "target_node": "File Processing Worker", "relation_type": "uploads settlement file", "source_kind": "API", "target_kind": "COMPUTE", "confidence": .86, "evidence": {}},
    {"external_edge_id": "demo-29", "source_name": "SIH demo", "source_node": "File Processing Worker", "target_node": "Unsigned Parser Package", "relation_type": "dependency execution", "source_kind": "COMPUTE", "target_kind": "VULNERABILITY", "confidence": .82, "evidence": {}},
    {"external_edge_id": "demo-30", "source_name": "SIH demo", "source_node": "Unsigned Parser Package", "target_node": "Settlement Service Role", "relation_type": "worker token theft", "source_kind": "VULNERABILITY", "target_kind": "IDENTITY", "confidence": .78, "evidence": {}},
    {"external_edge_id": "demo-31", "source_name": "SIH demo", "source_node": "Settlement Service Role", "target_node": "Settlement Ledger", "relation_type": "ledger write access", "source_kind": "IDENTITY", "target_kind": "CROWN_JEWEL", "confidence": .76, "evidence": {"financial_impact_inr": 89000000}},
    {"external_edge_id": "demo-32", "source_name": "SIH demo", "source_node": "Internet", "target_node": "Mobile Banking API", "relation_type": "public mobile endpoint", "source_kind": "INTERNET", "target_kind": "API", "confidence": .96, "evidence": {}},
    {"external_edge_id": "demo-33", "source_name": "SIH demo", "source_node": "Mobile Banking API", "target_node": "Rate Limit Control Gap", "relation_type": "credential stuffing", "source_kind": "API", "target_kind": "VULNERABILITY", "confidence": .88, "evidence": {}},
    {"external_edge_id": "demo-34", "source_name": "SIH demo", "source_node": "Rate Limit Control Gap", "target_node": "Customer Session Role", "relation_type": "session takeover", "source_kind": "VULNERABILITY", "target_kind": "IDENTITY", "confidence": .84, "evidence": {}},
    {"external_edge_id": "demo-35", "source_name": "SIH demo", "source_node": "Customer Session Role", "target_node": "Account Profile Store", "relation_type": "profile read access", "source_kind": "IDENTITY", "target_kind": "CROWN_JEWEL", "confidence": .81, "evidence": {"financial_impact_inr": 62000000}},
    {"external_edge_id": "demo-36", "source_name": "SIH demo", "source_node": "Finance Endpoint", "target_node": "Browser Session Token", "relation_type": "cookie extraction", "source_kind": "COMPUTE", "target_kind": "IDENTITY", "confidence": .77, "evidence": {}},
    {"external_edge_id": "demo-37", "source_name": "SIH demo", "source_node": "Browser Session Token", "target_node": "Treasury Portal", "relation_type": "session replay", "source_kind": "IDENTITY", "target_kind": "API", "confidence": .74, "evidence": {}},
    {"external_edge_id": "demo-38", "source_name": "SIH demo", "source_node": "Treasury Portal", "target_node": "Payment Approval Queue", "relation_type": "approves payment batch", "source_kind": "API", "target_kind": "CRITICAL_ASSET", "confidence": .70, "evidence": {"financial_impact_inr": 97000000}},
    {"external_edge_id": "demo-39", "source_name": "SIH demo", "source_node": "Production Kubernetes", "target_node": "Cloud Metadata Endpoint", "relation_type": "metadata access", "source_kind": "COMPUTE", "target_kind": "API", "confidence": .79, "evidence": {}},
    {"external_edge_id": "demo-40", "source_name": "SIH demo", "source_node": "Cloud Metadata Endpoint", "target_node": "Analytics Workload Role", "relation_type": "temporary credential", "source_kind": "API", "target_kind": "IDENTITY", "confidence": .75, "evidence": {}},
    {"external_edge_id": "demo-41", "source_name": "SIH demo", "source_node": "Analytics Workload Role", "target_node": "Analytics Warehouse", "relation_type": "warehouse admin", "source_kind": "IDENTITY", "target_kind": "CROWN_JEWEL", "confidence": .72, "evidence": {"financial_impact_inr": 74000000}},
    {"external_edge_id": "demo-42", "source_name": "SIH demo", "source_node": "Public API Gateway", "target_node": "Message Broker", "relation_type": "publishes events", "source_kind": "API", "target_kind": "COMPUTE", "confidence": .85, "evidence": {}},
    {"external_edge_id": "demo-43", "source_name": "SIH demo", "source_node": "Message Broker", "target_node": "Notification Worker", "relation_type": "consumer trust", "source_kind": "COMPUTE", "target_kind": "COMPUTE", "confidence": .80, "evidence": {}},
    {"external_edge_id": "demo-44", "source_name": "SIH demo", "source_node": "Notification Worker", "target_node": "Customer Contact Vault", "relation_type": "bulk export permission", "source_kind": "COMPUTE", "target_kind": "CROWN_JEWEL", "confidence": .77, "evidence": {"financial_impact_inr": 58000000}},
]
